...
if uploaded_file:
        ...
        try:
            ...
            with col2:
                ...
                fig_bar.update_layout(
                    ...
                    yaxis={'tickformat': ','},
                    # 여기에 마진(여백) 설정 추가
                    margin=dict(l=160, r=10, t=50, b=70) # 예시 값. 필요에 따라 조정 가능
    ...
    st.info("데이터 분석을 시작하려면 **ERP > Business Intelligence > 경영정보 > 매출채권현황(유피)** 메뉴의 '세부현황' 탭에서 최근 결산일자의 엑셀 파일을 받아서 업로드하세요."
    st.info("조회조건 중에서 **'연체'** 체크박스는 **체크 해제**하셔야 합니다.")
